                            ...
                            <div class="card-body p-0">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        <input class="form-check-input me-1 fs-1 w-75" type="text" value="{{ $product->name }}">
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <input class="form-check-input me-1 fs-1 w-75" type="number" value="{{ $product->price }}">
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <li class="list-group-item" style="height: 300px">
                                        ...
                                        <hr>
                                        <textarea name="desc" class="w-100" style="resize: none; min-heigt: 150px;">{{ $product->desc }}</textarea>
                                    </li>
                                </ul>
